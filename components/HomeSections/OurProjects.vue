  ...
  <section id="ourProjects">
    <v-container>
      <div class="text-center">
        <h1 class="text-4xl title text-gradient">مشاريعنا</h1>
        <p class="text-center mt-2 opacity-90 text-xl">
          نفخر بالمعارض والفعاليات التي نظمناها بنجاح، والتي ساهمت في تطوير
          القطاعات المختلفة في اليمن
        </p>
        <div class="line-gradient mt-8"></div>
      </div>
      <div class="text-end mb-4">
        <v-btn variant="outlined" text="عرض الكل" append-icon="mdi-arrange-bring-forward" to="/projects" color="primary" v-if="props.projects && props.projects?.length > 0"/>
      </div>
      ...
      <div
        class="card-gradient mt-16 d-flex flex-column align-center justify-center ga-4"
      >
        <h1 class="text-4xl font-bold">المشاريع القادمة</h1>
        <p class="text-xl">
          نعمل حالياً على تنظيم معارض جديدة ومثيرة في مختلف القطاعات
        </p>
